========================================================================
   APLICACIÓN: SimplexSolver Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación SimplexSolver.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación SimplexSolver.

SimplexSolver.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado SimplexSolver.pch y un archivo de tipos 
